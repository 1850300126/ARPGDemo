...
namespace TreeDesigner.Editor
{
    public class BaseTreeView : GraphView
    {
        ...
        static MonoScript m_MonoScript;
        ...
        public BaseTreeView()
        {
            ...
            IMGUIContainer nodeSearchContainer = new IMGUIContainer(() =>
            {
                ...
                m_MonoScript = EditorGUILayout.ObjectField("", m_MonoScript, typeof(MonoScript), false) as MonoScript;
                if (GUILayout.Button("Find"))
                {
                    ...
                    {
                        if(nodeView.Node.GetType() == m_MonoScript.GetClass())
