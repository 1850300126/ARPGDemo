...
namespace Taco.Timeline.Editor
{
    public class TimelineFieldView : VisualElement, ISelection
    {
        ...
        public float ScrollViewContentWidth => ScrollView.contentContainer.worldBound.width;
        public float ScrollViewContentOffset => ScrollView.scrollOffset.x;
        ...
        public TimelineFieldView() 
        {
            ...
            ScrollView.RegisterCallback<PointerMoveEvent>((e) =>
            {
                if (m_ScrollViewPan)
                {
                    ScrollView.scrollOffset = new Vector2(ScrollView.scrollOffset.x + m_ScrollViewPanDelta - e.localPosition.x, ScrollView.scrollOffset.y);
                    m_ScrollViewPanDelta = e.localPosition.x;
                }
            });
            ScrollView.RegisterCallback<PointerOutEvent>((e) =>
            {
            ...
            ScrollView.horizontalScroller.valueChanged += (e) =>
            {
                    ...
                    case KeyCode.F:
                        {
                            ...
                            ScrollView.scrollOffset = new Vector2(middleFrame * OneFrameWidth, ScrollView.scrollOffset.y);
                        }
                        break;
                }
            });
        ...
        public void PopulateView()
        {
            ...
            if (Timeline)
            {
                EditorWindow.UpdateSerializedTimeline();
                    ...
                    case Track track:
                        {
                            ...
                            serializedProperty = serializedProperty.GetArrayElementAtIndex(EditorWindow.Timeline.Tracks.IndexOf(track));
                    ...
                    case Clip clip:
                        {
                            ...
                            SerializedProperty serializedProperty = EditorWindow.SerializedTimeline.FindProperty("m_Tracks");
                            serializedProperty = serializedProperty.GetArrayElementAtIndex(EditorWindow.Timeline.Tracks.IndexOf(clip.Track));
            ...
            foreach (var fieldInfo in target.GetAllFields())
            {
                if (fieldInfo.GetCustomAttribute<ShowInInspectorAttribute>() is ShowInInspectorAttribute showInInspectorAttribute)
                {
                    ...
                    if (sp != null)
                    {
                        ...
                        propertyField.Bind(EditorWindow.SerializedTimeline);
        ...
        void OnTrackFieldGenerateVisualContent(MeshGenerationContext mgc)
        {
            ...
            for (int i = startFrame; i <= endFrame; i++)
            {
                if (i % (showInterval * 5) == 0)
                {
                    ...
                    paint2D.LineTo(new Vector2(FramePosMap[i], ScrollView.worldBound.height));
                }
            }
            paint2D.Stroke();
        }
        ...
        void OnTimeLocatorGenerateVisualContent(MeshGenerationContext mgc)
        {
            ...
            paint2D.LineTo(new Vector2(0, ScrollView.worldBound.height));
            paint2D.Stroke();
        }
        #endregion
        ...
        void OnDrawFrameLineFieldGenerateVisualContent(MeshGenerationContext mgc)
        {
            ...
            {
                int count = Mathf.CeilToInt(ScrollView.worldBound.height / 5);
        ...
        void OnlWheelEvent(WheelEvent wheelEvent)
        {
            ...
            else
            {
                ...
                ScrollView.scrollOffset = new Vector2(targetOffset, ScrollView.scrollOffset.y);

                ResizeTimeField();
                ForceScrollViewUpdate(ScrollView);
            }
